...
export async function sendOrderStatusUpdate(order: any, newStatus: string) {
    ...
    const statusConfig: Record<string, { icon: string; color: string; bg: string }> = {
        processing: { icon: '&#9881;', color: '#0C4534', bg: '#EEE5D4' },
        shipped: { icon: '&#128666;', color: '#0C4534', bg: '#EEE5D4' },
        delivered: { icon: '&#127881;', color: '#0C4534', bg: '#EEE5D4' },
        cancelled: { icon: '&#10060;', color: '#4E3521', bg: '#EEE5D4' },
    };
    const sc = statusConfig[newStatus] || { icon: '&#128276;', color: '#292524', bg: '#EEE5D4' };
...
<p style="color:#292524;font-size:14px;line-height:1.7;margin:16px 0;">Thank you for joining the ${BRAND.name} family. We offer stylish, quality wigs, extensions, bundles and shapewear at budget-friendly prices &mdash; confidence in every strand.</p>

<div style="background-color:#EEE5D4;border-radius:12px;padding:20px;margin:20px 0;">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
    <tr>
      <td style="text-align:center;padding:8px;width:33%;">
        <p style="font-size:20px;margin:0 0 4px;">&#128135;</p>
        <p style="color:#0C4534;font-size:12px;font-weight:600;margin:0;">Wigs &amp; Bundles</p>
        <p style="color:#194E3C;font-size:11px;margin:2px 0 0;">Retail + wholesale</p>
      </td>
      <td style="text-align:center;padding:8px;width:33%;">
        <p style="font-size:20px;margin:0 0 4px;">&#10024;</p>
        <p style="color:#0C4534;font-size:12px;font-weight:600;margin:0;">Quality Hair</p>
        <p style="color:#194E3C;font-size:11px;margin:2px 0 0;">Styled for you</p>
      </td>
      <td style="text-align:center;padding:8px;width:33%;">
        <p style="font-size:20px;margin:0 0 4px;">&#128176;</p>
        <p style="color:#0C4534;font-size:12px;font-weight:600;margin:0;">Budget Prices</p>
        <p style="color:#194E3C;font-size:11px;margin:2px 0 0;">No compromise</p>
      </td>
    </tr>
  </table>
</div>
