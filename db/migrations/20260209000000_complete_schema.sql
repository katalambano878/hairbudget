-- ============================================================================
-- COMPLETE DATABASE SCHEMA MIGRATION (plain PostgreSQL)
--
-- This single migration creates the entire database from scratch.
-- Run this on a fresh PostgreSQL 14+ database to get the full schema.
-- ============================================================================
...
-- Users (application-managed authentication accounts)
...
-- ============================================================================
-- 7. FILE STORAGE (database-backed object store)
-- ============================================================================
...
CREATE INDEX idx_storage_objects_bucket_path ON public.storage_objects (bucket, path);
