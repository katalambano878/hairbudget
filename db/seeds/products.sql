...
BEGIN
  FOR r IN
    SELECT * FROM (VALUES
      ...
      ('Bone Straight',        'bone-straight',        85.20,   'human-hairs',          30, 'HB-BONESTRA-IGHT'),
      ('Bone Straight- Black', 'bone-straight-black',  75.50,   'human-hairs',          30, 'HB-BONESTBL-ACK'),
      ('Braids',               'braids',              419.95,   'braiding-extensions',  20, 'HB-BRAIDS-0001'),
      ('Curls',                'curls',                55.00,   'human-hairs',          35, 'HB-CURLS-00001'),
      ('Curly Hair',           'curly-hair',          139.95,   'human-hairs',          25, 'HB-CURLYHAI-R001'),
      ('Extension',            'extension',            55.00,   'braiding-extensions',  50, 'HB-EXTENSIO-N001'),
      ('French curl',          'french-curl',         250.50,   'human-hairs',          18, 'HB-FRENCHCU-R001'),
      ('French Curls',         'french-curls-109',    109.95,   'human-hairs',          22, 'HB-FRENCH10-9CUR'),
      ('French Curls',         'french-curls-120',    120.00,   'human-hairs',          22, 'HB-FRENCH12-0CUR'),
      ('French curly hair',    'french-curly-hair',   100.12,   'human-hairs',          24, 'HB-FRENCHCU-RLYH'),
      ('Grey spiral',          'grey-spiral',          95.00,   'braiding-extensions',  28, 'HB-GREYSPIR-AL01'),
      ('Indian Hair',          'indian-hair',          67.95,   'human-hairs',          40, 'HB-INDIANHA-IR01'),
      ('Indian Spiral',        'indian-spiral',       281.95,   'human-hairs',          16, 'HB-INDIANSP-IRAL'),
      ...
      ('Spiral Hair',          'spiral-hair',         189.95,   'human-hairs',          20, 'HB-SPIRALHA-IR01'),
      ('Wavy curls',           'wavy-curls',          100.12,   'human-hairs',          24, 'HB-WAVYCURL-S001'),
