...
const defaultSettings: SiteSettings = {
    site_name: 'HairBudget',
    site_tagline: 'Confidence in every strand',
    site_logo: '/logo.png',
    contact_email: 'info@hairbudgetgh.com',
    contact_phone: '059 892 8819',
    contact_address: '1 Kwei-Fio St, Adenta Municipality, Ghana',
    social_facebook: '',
    social_instagram: 'https://www.instagram.com/hairbudget_yassi/',
    social_twitter: '',
    social_tiktok: 'https://www.tiktok.com/@hairbudget22',
    social_snapchat: 'https://www.snapchat.com/add/hairbudget',
    social_youtube: '',
    primary_color: '#0C4534',
    secondary_color: '#EEE5D4',
    currency: 'GHS',
    currency_symbol: 'GH₵',
};
