...
export const metadata: Metadata = buildMetadata({
  title: 'HairBudget Journal — Hair Tips, Trends & Stories',
  description:
    'Style guides, hair-care advice and trend reports from the HairBudget team. Learn how to install, maintain and rock your favourite wigs.',
  path: '/blog',
