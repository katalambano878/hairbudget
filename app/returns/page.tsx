    ...
    <main className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-4xl mx-auto px-4">
          <div className="mb-8 rounded-2xl bg-brand-forest text-brand-ivory p-6">
            ...
            <h1 className="font-serif text-2xl italic mb-2">No refunds · 24-hour exchange</h1>
            <p className="text-sm text-brand-cream/90 leading-relaxed">
              HairBudget does not issue refunds. Unused items in original condition may be exchanged within 24 hours of purchase. WhatsApp us to start an exchange.
            </p>
          </div>
