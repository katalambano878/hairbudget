...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    'HairBudget pickup and delivery across Ghana. Collect from Adenta or have your order delivered.',
  path: '/shipping',
...
export default function ShippingPage() {
  const deliveryOptions = [
    ...
    },
    {
      ...
      time: 'Same Day',
      cost: 'FREE',
      description: 'Collect from 1 Kwei-Fio St, Adenta Municipality',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Pickup and delivery available. Chat us on WhatsApp to confirm your area and timing.
            </p>
          </div>
        </div>
      </div>
